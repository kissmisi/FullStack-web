...
function IrSzam() {
  ...
  let url="http://localhost:3000/iranyitoszamok"
...
function IrSzam1() {
  let url="http://localhost:3000/iranyitoszamok1"
...
function osszegzes(){
  let url="http://localhost:3000/osszegzes"
...
function rendelesVeglegesit(){
  let url="http://localhost:3000/veglegesit"
  ...
  fetch(url, fetchOptions)
    ...
    .then(y=>{
      ...
      fetch("http://localhost:3000/klimaUpdate", {
        method: "POST",
        ...
        .then(y=>{
          ...
          fetch("http://localhost:3000/kosarurit", {
            method: "POST",
...
/*function adatok() {
    let url = "http://localhost:3000/adatokGet"
    fetch(url)
      .then(x => x.json())
      .then(y => megjelenit(y))
